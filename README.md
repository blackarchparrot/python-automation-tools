...
Stop renaming files one by one. **File Renamer** is a high-performance Python utility designed to handle bulk extension changes with zero friction. Featuring a clean, modern GUI, this tool gives you the power to transform entire directories—and their subfolders—in seconds.
...
Interface: PySimpleGUI (Handled automatically)
...
---
by [Aftab Sunny](https://github.com/blackarchparrot).
